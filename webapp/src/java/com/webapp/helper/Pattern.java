...
public class Pattern {
	...
	public static int threshold=3;//min no.of times for the pattern to appear
	...
	public static void heapPermutation(int a[], int size, int n)
	{
        ...
        public static HashSet<List<Integer>> finPattern(int[] arr,int[] prof_list,StringBuffer sb){
               // System.out.println("************************************************");
		//System.out.println("Program to demonstrate pattern Matching");
                ...
                sb.append("Here we generate each permutation of LTWEI and check if the current permutation appers more than threshold ("+threshold+") times <br>"
                        + "If appears we consider them as cartel and increase temp score for pattern for all such traders");
